class AddTruckView {
    ...
    wire() {
        ...
        // CRITICAL: Use shown.bs.modal instead of show.bs.modal
        this.modal.addEventListener('shown.bs.modal', () => {
            console.log('Add modal shown, initializing map...');
            this.initMap();
        });
        
        this.modal.addEventListener('hidden.bs.modal', () => {
            console.log('Add modal hidden, resetting...');
            this.resetForm();
        });
    ...
    initMap() {
        ...
        try {
            ...
            console.log('✅ Add modal map initialized successfully');
    ...
    resetForm() {
        ...
        console.log('✅ Add modal form reset completed');
    }
